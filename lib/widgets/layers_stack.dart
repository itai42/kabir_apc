...
typedef RefWidgetBuilder = Widget Function(BuildContext context, {required LayerStackWidget layerStackWidget, required Widget child});

/// Signature of callbacks that have no arguments and returns a boolean.
typedef BooleanCallback = void Function();

class LayerStackWidget extends StatefulWidget {
  ...
  @override
  State<LayerStackWidget> createState() => LayerStackWidgetState();

  static Widget defaultChildBuilder(BuildContext context, {required LayerStackWidget layerStackWidget, required Widget child}) => child;

  static Widget defaultSizingBuilder(BuildContext context, {required LayerStackWidget layerStackWidget, required Widget child}) =>
  ...
  static Widget defaultContainerBuilder(BuildContext context, {required LayerStackWidget layerStackWidget, required Widget child}) =>
      //SingleChildScrollView(
      //child:
      Card(elevation: 0,
        margin: EdgeInsets.zero,
        color: layerStackWidget.cardColor,
        shadowColor: layerStackWidget.cardShadowColor, //Colors.brown.shade100.withOpacity(0.2),
        child: SingleChildScrollView(padding: EdgeInsets.zero, child: child),
        // )
      );
}

class LayerStackWidgetState extends State<LayerStackWidget> {
    ...
    return Stack(textDirection: Directionality.of(context).reverse, fit: StackFit.loose,clipBehavior: Clip.hardEdge,
        ...
        children: [
          Collapsible(
            ...
            child: widget.sizingBuilder(context, layerStackWidget: widget, child: widget.containerBuilder(context, layerStackWidget: widget, child: widget.childBuilder(context, layerStackWidget: widget, child: widget.child))),
          ),
